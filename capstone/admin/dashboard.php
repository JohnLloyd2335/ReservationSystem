...
<head>
    ...
    <title>Ha-Boogies Archer Resort - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">Ha-Boogies Archer<sup></sup></div>
            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                $dash_users_query = "SELECT * FROM user";
                                                $dash_users_query_run = mysqli_query($con, $dash_users_query);

                                                if ($users_total = mysqli_num_rows($dash_users_query_run)) {
                                                  echo '<h4 class="number counter mb-0 font-weight-bold text-gray-800"> ' . $users_total . ' </h4>';
                                                } else {
                                                  echo '<h4 class="number counter mb-0 font-weight-bold text-gray-800"> 0 </h4>';
                                                }
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $dash_users_query = "SELECT * FROM rooms";
                                                $dash_users_query_run = mysqli_query($con, $dash_users_query);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $dash_users_query = "SELECT * FROM cottage";
                                                $dash_users_query_run = mysqli_query($con, $dash_users_query);
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    <?php
                                                        $dash_users_query = "SELECT * FROM services";
                                                        $dash_users_query_run = mysqli_query($con, $dash_users_query);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $dash_users_query = "SELECT * FROM cottagereservation";
                                                $dash_users_query_run = mysqli_query($con, $dash_users_query);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $dash_users_query = "SELECT * FROM archive";
                                                $dash_users_query_run = mysqli_query($con, $dash_users_query);

                                                if ($archive_total = mysqli_num_rows($dash_users_query_run)) {
                                                  echo '<h4 class="number counter mb-0 font-weight-bold text-gray-800"> ' . $archive_total . ' </h4>';
                                                } else {
                                                  echo '<h4 class="number counter mb-0 font-weight-bold text-gray-800"> 0 </h4>';
                                                }
    ...
    <script src="boost/js/demo/chart-area-demo.js"></script>
    <script src="boost/js/demo/chart-pie-demo.js"></script>
