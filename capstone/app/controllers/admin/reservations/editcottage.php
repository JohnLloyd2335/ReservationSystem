...
if (isset($_POST['editbutton1'])) {
    ...
    if (empty($error_array)) { //If No Error Statement
        ...
        $query1 = mysqli_query($con, "UPDATE cottagereservation SET cottagetype='$cottagetype', checkin='$checkin', checkout='$checkout', adult='$adultnum', children='$childrennum' WHERE id=$id");
