...
if (isset($_POST['editprofilebutton']) && isset($_FILES['image'])) {
    ...
    if ($error === 0) {
		if ($img_size > 5097152) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
				...
				$query1 = mysqli_query($con, "UPDATE user SET fname='$first_name', lname='$last_name', mobilenum='$mobnum', profile_picture='$new_img_name' WHERE id=$id");
