<?php 
    ...
    if(isset($_SESSION['login'])){
      ...
      if(isset($_SESSION['inputroom'])){
        $inputroom=$_SESSION['inputroom'];
      }else{
        $inputroom="";
      }
...
<html>
    ...
    <body onload="getSelectedIndex('<?php echo $inputroom ?>'); getSelectedIndexAdult(<?php echo $inputadultnum ?>); getSelectedIndexChildren(<?php echo $inputchildrennum ?>)">
    <?php
        include "../navbar.php";
    ?>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="row w-100 p-2">
                                <div class="col-sm">
                                    <select class="form-select form-select-lg w-50 h-100 p-2" name="room" aria-label=".form-select-lg example" id="rooms">
                            ...
                            <center> <div class="row w-100 p-3" > 
                                ...
                                <div class="col-sm">
                                <p> Check out </p>
                                    <input class="form-control form-select-lg w-100 h-50 p-2" type="date" id="checkout" name="checkout"  placeholder="Check-out" value="<?php echo $inputcheckout?>">
                                </div>
                            </div>
                            <div class="row w-100 p-2">
                                <div class="col-sm">
    ...
    <section class="section visit-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
           <img src="../pictures/single2.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
            <img src="../pictures/single3.jpg" alt="Image placeholder" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3"  >
            <img src="../pictures/single4.jpg" alt="Image placeholder" class="img-fluid">
            ...
            <p class="contenter" >These rooms are assigned to one person or a couple.</p>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="heading"><b>Twin Room</b></h2>
            <hr>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-md-6 visit mb-3">
            <img src="../pictures/twin.jpg" alt="Image placeholder" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
           <img src="../pictures/twin1.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
            <img src="../pictures/twin3.png" alt="Image placeholder" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3"  >
            <img src="../pictures/twin4.png" alt="Image placeholder" class="img-fluid">
            ...
            <p class="contenter">A hotel room containing two single beds.</p>
        </div>
      </div>
      <br>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="heading"><b>Triple Room</b></h2>
            <hr>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-md-6 visit mb-3">
            <img src="../pictures/triple1.jpg" alt="Image placeholder" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
           <img src="../pictures/triple2.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
            <img src="../pictures/triple3.jpg" alt="Image placeholder" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3"  >
            <img src="../pictures/triple4.jpg" alt="Image placeholder" class="img-fluid">
            ...
            <p class="contenter">A room suitable for up to 3 guests. The room contains two regular beds and one extra bed in a superior twin room.</p>
        </div>
        <br>
      <!-- <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="heading"><b>room</b></h2>
            <hr>
          </div>
          </div>
         <div class="row">
          <div class="col-lg-3 col-md-6 visit mb-3">
           <img src="../pictures/room1.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3">
            <img src="../pictures/room2.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3"  >
            <img src="../pictures/room3.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">

            </div>
      </div>
      <div class="col-lg-3 col-md-6 visit mb-3"  >
            <img src="../pictures/room4.jpg" alt="Image placeholder" class="img-fluid">
            <div class="reviews-star float-left">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group mb-3">
            <select class="form-select w-100 p-2" name="roomnum" aria-label="Default select example">
                <option disabled selected hidden>room No.</option>
                <option value="1">1</option>
                <option value="2">2</option>
